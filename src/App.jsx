...
// Read API URL from environment variable or fallback to production
const API = import.meta.env.VITE_API_URL || "https://gympro-backend-production-2c21.up.railway.app/api";
